...
// Description is an option that can be passed to a FieldFunc to add a
// description to the field.
var Description = func(desc string) fieldFuncOptionFunc {
...
// FieldDesc adds a description to an autogenerated field from the object type
func (s *Object) FieldDesc(name string, description string) {
	if s.FieldDescriptions == nil {
		s.FieldDescriptions = make(map[string]string)
	}
	s.FieldDescriptions[name] = description
}
